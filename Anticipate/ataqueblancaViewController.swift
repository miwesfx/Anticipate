//
//  ataqueblancaViewController.swift
//  Anticipate
//
...
class ataqueblancaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/blancar.mp4")!
