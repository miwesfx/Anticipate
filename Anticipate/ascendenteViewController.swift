//
//  ascendenteViewController.swift
//  Anticipate
//
...
class ascendenteViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/ascendenter.mp4")!
