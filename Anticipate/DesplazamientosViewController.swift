//
//  DesplazamientosViewController.swift
//  Anticipate
//
...
class DesplazamientosViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/desplazamientosr.mp4")!
