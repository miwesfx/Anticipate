//
//  PosicionSeguridadViewController.swift
//  Anticipate
//
...
class PosicionSeguridadViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/posicionr.mp4")!
