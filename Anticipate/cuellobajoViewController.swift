//
//  cuellobajoViewController.swift
//  Anticipate
//
...
class cuellobajoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/cuellobajor.mp4")!
