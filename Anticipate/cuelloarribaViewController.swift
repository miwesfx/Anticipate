//
//  cuelloarribaViewController.swift
//  Anticipate
//
...
class cuelloarribaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/cuelloarribar.mp4")!
