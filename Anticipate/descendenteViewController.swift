//
//  descendenteViewController.swift
//  Anticipate
//
...
class descendenteViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/descendenter.mp4")!
