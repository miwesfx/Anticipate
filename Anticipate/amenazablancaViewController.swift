//
//  amenazablancaViewController.swift
//  Anticipate
//
...
class amenazablancaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url:NSURL = NSURL(string: "http://videos.escuelaprevencionviolencia.es/vg/blancadelanter.mp4")!
